  ...
  return (
    <>
      ...
      <div className="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
        <h4 className="text-white fw-semibold mb-0">Invoices</h4>
        <Link
          href="/invoices/new"
            ...
            <div className="card-body py-3">
              <div className="d-flex align-items-center gap-3">
                <div
                  ...
                  style={{ width: '40px', height: '40px', background: '#fd7e1422' }}
                >
                  <Icon icon="mdi:clock-outline" style={{ fontSize: '20px', color: '#fd7e14' }} />
                </div>
                <div>
                  <span className="text-secondary-light text-xs d-block">Total Outstanding</span>
          ...
          <div className="card">
            <div className="card-body py-3">
              <div className="d-flex align-items-center gap-3">
                <div
                  className="d-flex align-items-center justify-content-center rounded-circle"
                  style={{ width: '40px', height: '40px', background: '#19875422' }}
                >
                  <Icon icon="mdi:check-circle-outline" style={{ fontSize: '20px', color: '#198754' }} />
                </div>
                <div>
                  <span className="text-secondary-light text-xs d-block">Paid This Month</span>
                  <span className="text-white fw-semibold">
          ...
          <div className="card">
            <div className="card-body py-3">
              <div className="d-flex align-items-center gap-3">
                <div
                  className="d-flex align-items-center justify-content-center rounded-circle"
                  style={{ width: '40px', height: '40px', background: '#dc354522' }}
                >
                  <Icon icon="mdi:alert-circle-outline" style={{ fontSize: '20px', color: '#dc3545' }} />
                </div>
                <div>
                  <span className="text-secondary-light text-xs d-block">Overdue</span>
                  <span className="text-white fw-semibold">
          ...
          {invoices.length === 0 ? (
            <div className="d-flex flex-column justify-content-center align-items-center py-80">
              <Icon
                ...
                style={{ fontSize: '48px' }}
              />
              <h6 className="text-white fw-semibold mb-2">No invoices yet.</h6>
                  ...
                  {invoices.map((inv) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td>
                          <span className="text-white text-sm">{inv.clientName || '—'}</span>
                          {inv.clientCompany && (
