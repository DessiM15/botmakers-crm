...
export async function getClientById(id) {
  const [client] = await db
    .select({
      ...
      portalInviteCount: clients.portalInviteCount,
      portalLastLoginAt: clients.portalLastLoginAt,
      portalFirstLoginAt: clients.portalFirstLoginAt,
      portalOnboardingComplete: clients.portalOnboardingComplete,
      portalAccessRevoked: clients.portalAccessRevoked,
